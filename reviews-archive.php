...
<head>
  ...
  <link rel="canonical" href="<?php echo $canonicalBase; ?>/reviews-archive" />
  <title>Reviews Archive — DevicesArena</title>
    ...
    <div class="cp-hero">
      ...
      <div class="cp-hero-inner">
        <div class="cp-hero-left">
          <div class="cp-hero-label"><span>Content</span></div>
          <h1 class="cp-hero-title">Reviews Archive</h1>
