  ...
  <div class="d-lg-none d-block">
    ...
    <div class="phone-box">
      ...
      <div class="bottom-section">
        ...
        <button class="review-btn" onclick="window.location.href='/device/<?php echo htmlspecialchars($device['slug']); ?>/images'">
          PICTURES
        </button>
...
">
              <!-- Left: Phone Image -->
              <div class="phone-image me-3 py-2  px-2" onclick="window.location.href='/device/<?php echo htmlspecialchars($device['slug']); ?>/images'" style="cursor: pointer;"></div>
            </div>
          ...
          <div class="article-info">
            <div class="bg-blur">
              <div class="d-flex justify-content-end">
                ...
                <div class="d-flex flexiable ">
                  <img src="/imges/download-removebg-preview.png" alt="">
                  <h5 style="font-family:system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue' ; font-size: 16px; cursor: pointer; font-weight: 700;" class="mt-2" onclick="window.location.href='/device/<?php echo htmlspecialchars($device['slug']); ?>/images'">PICTURES</h5>
                </div>
                <div class="d-flex flexiable ">
                  <img src="/imges/download-removebg-preview.png" alt="">
      ...
      <div class="col-lg-8 col-md-7 order-1" style="padding-right: 0;">
        <div class="bg-white">
          ...
          <div class="d-block d-lg-flex">
            ...
            <button class="pad" onclick="window.location.href='/device/<?php echo htmlspecialchars($device['slug']); ?>/images'">PICTURES</button>
