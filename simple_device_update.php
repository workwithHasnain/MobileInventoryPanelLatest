...
function simpleUpdateDevice($id, $phone)
{
    try {
        ...
        $params = [
            ...
            ':platform' => $nullIfEmpty($phone['platform'] ?? $existing['platform'] ?? null),
            ...
            ':sound' => $nullIfEmpty($phone['sound'] ?? $existing['sound'] ?? null),
            ':comms' => $nullIfEmpty($phone['comms'] ?? $existing['comms'] ?? null),
            ':features' => $nullIfEmpty($phone['features'] ?? $existing['features'] ?? null),
            ':battery' => $nullIfEmpty($phone['battery'] ?? $existing['battery'] ?? null),
            ':misc' => $nullIfEmpty($phone['misc'] ?? $existing['misc'] ?? null),
