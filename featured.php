...
<body style="background-color: #EFEBE9;">
    ...
    <div class="container  margin-top-4rem">
        <div class="row">
            ...
            ?>
                <div class="col-lg-8 col-md-6 col-12 sentizer-erx grid-colums" id="posts-feed-container" style="background-color: #EEEEEE;">
    ...
    <script>
        ...
        (function() {
            ...
            function loadMorePosts() {
                ...
                let url = '<?php echo $base; ?>load_posts.php?page=' + currentPage + '&type=featured&format=review';
