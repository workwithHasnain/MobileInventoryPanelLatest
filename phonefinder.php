    ...
    <div class="cp-hero">
      ...
      <div class="cp-hero-inner">
        <div class="cp-hero-left">
          ...
          <p class="cp-hero-sub">Look for your dream phone from our extensive database of mobile phones with the help of
            48 detailed filters.</p>
        </div>
        ...
        <div class="da-widget-body">
          <div class="row">
            ...
            <div class="col-lg-6 col-12" id="pf-left-col">
              ...
              <button class="btn btn-outline-secondary w-100 text-start mb-2" type="button" data-bs-toggle="collapse"
                    ...
                    foreach ($brands as $brand) {
                      ...
                      <div class="form-check">
                        ...
                        <label class="form-check-label"
                          for="<?php echo $brandCheckboxId; ?>"><?php echo htmlspecialchars($brand['name']); ?></label>
                      </div>
                      <?php
                    }
                  } else {
              ...
              <div class="collapse" id="networkCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <div class="form-check"><input class="form-check-input" type="checkbox" value="Available"
                      id="availabilityAvailable" name="availability" /><label class="form-check-label"
                      for="availabilityAvailable">Available</label></div>
                  <div class="form-check"><input class="form-check-input" type="checkbox" value="Coming Soon"
                      id="availabilityComingSoon" name="availability" /><label class="form-check-label"
                      for="availabilityComingSoon">Coming Soon</label></div>
                  <div class="form-check"><input class="form-check-input" type="checkbox" value="Discontinued"
                      id="availabilityDiscontinued" name="availability" /><label class="form-check-label"
                      for="availabilityDiscontinued">Discontinued</label></div>
                  <div class="form-check"><input class="form-check-input" type="checkbox" value="Rumored"
                      id="availabilityRumored" name="availability" /><label class="form-check-label"
                      for="availabilityRumored">Rumored</label></div>
                </div>
              </div>
              ...
              <div class="da-range-slider-wrapper mb-3">
                <div class="d-flex justify-content-between align-items-center mb-1">
                  ...
                  <span class="badge bg-secondary"><span
                      id="yearMinValue"><?php echo $filterConfig['year']['default_min']; ?></span> - <span
                      id="yearMaxValue"><?php echo $filterConfig['year']['default_max']; ?></span></span>
                </div>
                <div class="d-flex align-items-center gap-2">
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['year']['min']; ?>" max="<?php echo $filterConfig['year']['max']; ?>"
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['price']['min']; ?>"
                    max="<?php echo $filterConfig['price']['max']; ?>"
                    step="<?php echo $filterConfig['price']['step']; ?>" id="priceMax" />
              ...
              <div class="collapse" id="colorCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <?php if (isset($filterConfig['colors']))
                    foreach ($filterConfig['colors'] as $index => $color): ?>
                      <div class="form-check"><input class="form-check-input" type="checkbox"
                          value="<?php echo htmlspecialchars($color); ?>" id="color<?php echo $index; ?>"
                          name="color[]" /><label class="form-check-label"
                          for="color<?php echo $index; ?>"><?php echo strtoupper(htmlspecialchars($color)); ?></label></div>
                    <?php endforeach; ?>
                </div>
              </div>
              ...
              <div class="row g-2 mb-2">
                <div class="col-6">
                  <button class="btn btn-outline-secondary w-100 text-start" type="button" data-bs-toggle="collapse"
                    data-bs-target="#simCollapse">2G <i class="fa fa-chevron-down float-end mt-1"></i></button>
                  <div class="collapse" id="simCollapse">
                    <div class="card card-body mt-2 da-filter-card">
                      <?php if (isset($filterConfig['network_2g_bands']))
                        foreach ($filterConfig['network_2g_bands'] as $index => $band): ?>
                          <div class="form-check"><input class="form-check-input network-2g-band" type="checkbox"
                              value="<?php echo htmlspecialchars($band['value']); ?>" id="gsm<?php echo $index; ?>"
                              name="network_2g_bands[]" /><label class="form-check-label"
                              for="gsm<?php echo $index; ?>"><?php echo htmlspecialchars($band['label']); ?></label></div>
                        <?php endforeach; ?>
                    </div>
                  </div>
                </div>
                <div class="col-6">
                  <button class="btn btn-outline-secondary w-100 text-start" type="button" data-bs-toggle="collapse"
                    data-bs-target="#simwasCollapse">3G <i class="fa fa-chevron-down float-end mt-1"></i></button>
                  <div class="collapse" id="simwasCollapse">
                    <div class="card card-body mt-2 da-filter-card">
                      <?php if (isset($filterConfig['network_3g_bands']))
                        foreach ($filterConfig['network_3g_bands'] as $index => $band): ?>
                          <div class="form-check"><input class="form-check-input network-3g-band" type="checkbox"
                              value="<?php echo htmlspecialchars($band['value']); ?>" id="hspa<?php echo $index; ?>"
                              name="network_3g_bands[]" /><label class="form-check-label"
                              for="hspa<?php echo $index; ?>"><?php echo htmlspecialchars($band['label']); ?></label></div>
                        <?php endforeach; ?>
                    </div>
                  </div>
                </div>
                <div class="col-6">
                  <button class="btn btn-outline-secondary w-100 text-start" type="button" data-bs-toggle="collapse"
                    data-bs-target="#fourGCollapse">4G <i class="fa fa-chevron-down float-end mt-1"></i></button>
                  <div class="collapse" id="fourGCollapse">
                    <div class="card card-body mt-2 da-filter-card">
                      <?php if (isset($filterConfig['network_4g_bands']))
                        foreach ($filterConfig['network_4g_bands'] as $index => $band): ?>
                          <div class="form-check"><input class="form-check-input network-4g-band" type="checkbox"
                              value="<?php echo htmlspecialchars($band['value']); ?>" id="lte<?php echo $index; ?>"
                              name="network_4g_bands[]" /><label class="form-check-label"
                              for="lte<?php echo $index; ?>"><?php echo htmlspecialchars($band['label']); ?></label></div>
                        <?php endforeach; ?>
                    </div>
                  </div>
                </div>
                <div class="col-6">
                  <button class="btn btn-outline-secondary w-100 text-start" type="button" data-bs-toggle="collapse"
                    data-bs-target="#fiveGCollapse">5G <i class="fa fa-chevron-down float-end mt-1"></i></button>
                  <div class="collapse" id="fiveGCollapse">
                    <div class="card card-body mt-2 da-filter-card">
                      <?php if (isset($filterConfig['network_5g_bands']))
                        foreach ($filterConfig['network_5g_bands'] as $index => $band): ?>
                          <div class="form-check"><input class="form-check-input network-5g-band" type="checkbox"
                              value="<?php echo htmlspecialchars($band['value']); ?>" id="nr5g<?php echo $index; ?>"
                              name="network_5g_bands[]" /><label class="form-check-label"
                              for="nr5g<?php echo $index; ?>"><?php echo htmlspecialchars($band['label']); ?></label></div>
                        <?php endforeach; ?>
                    </div>
                  </div>
                </div>
              ...
              <div class="collapse" id="sizeCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <?php if (isset($filterConfig['sim_types']))
                    foreach ($filterConfig['sim_types'] as $index => $simType): ?>
                      <div class="form-check"><input class="form-check-input" type="checkbox"
                          value="<?php echo htmlspecialchars($simType); ?>" id="simType<?php echo $index; ?>"
                          name="sim_sizes[]" /><label class="form-check-label"
                          for="simType<?php echo $index; ?>"><?php echo htmlspecialchars($simType); ?></label></div>
                    <?php endforeach; ?>
                </div>
              </div>
              ...
              <div class="row g-2 mb-3">
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
              ...
              <button class="btn btn-outline-secondary w-100 text-start mb-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#factorCollapse">
                Form Factor <i class="fa fa-chevron-down float-end mt-1"></i>
              </button>
              <div class="collapse" id="factorCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <?php if (isset($filterConfig['form_factors']))
                    foreach ($filterConfig['form_factors'] as $index => $factor): ?>
                      <div class="form-check"><input class="form-check-input" type="checkbox"
                          value="<?php echo htmlspecialchars($factor); ?>" id="formFactor<?php echo $index; ?>"
                          name="form_factor[]" /><label class="form-check-label"
                          for="formFactor<?php echo $index; ?>"><?php echo htmlspecialchars($factor); ?></label></div>
                    <?php endforeach; ?>
                </div>
              </div>
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['dimensions']['height_min']; ?>"
                    max="<?php echo $filterConfig['dimensions']['height_max']; ?>"
                    step="<?php echo $filterConfig['dimensions']['height_step']; ?>" id="heightMin"
                    value="<?php echo $filterConfig['dimensions']['height_min']; ?>">
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['dimensions']['width_min']; ?>"
                    max="<?php echo $filterConfig['dimensions']['width_max']; ?>"
                    step="<?php echo $filterConfig['dimensions']['width_step']; ?>" id="widthMin"
                    value="<?php echo $filterConfig['dimensions']['width_min']; ?>">
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['dimensions']['thickness_min']; ?>"
                    max="<?php echo $filterConfig['dimensions']['thickness_max']; ?>"
                    step="<?php echo $filterConfig['dimensions']['thickness_step']; ?>" id="thicknessMax"
                    value="<?php echo $filterConfig['dimensions']['thickness_min']; ?>">
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['dimensions']['weight_min']; ?>"
                    max="<?php echo $filterConfig['dimensions']['weight_max']; ?>"
                    step="<?php echo $filterConfig['dimensions']['weight_step']; ?>" id="weightMax"
                    value="<?php echo $filterConfig['dimensions']['weight_min']; ?>">
                  <span class="text-muted small"><?php echo $filterConfig['dimensions']['weight_max']; ?></span>
                </div>
              </div>

              <button class="btn btn-outline-secondary w-100 text-start mb-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#ipCollapse">
                IP Certificate <i class="fa fa-chevron-down float-end mt-1"></i>
              </button>
              <div class="collapse" id="ipCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <?php if (isset($filterConfig['ip_certificates']))
                    foreach ($filterConfig['ip_certificates'] as $index => $ipCert): ?>
                      <div class="form-check"><input class="form-check-input" type="checkbox"
                          value="<?php echo htmlspecialchars($ipCert); ?>" id="ip<?php echo $index; ?>"
                          name="ip_certificate[]" /><label class="form-check-label"
                          for="ip<?php echo $index; ?>"><?php echo htmlspecialchars($ipCert); ?></label></div>
                    <?php endforeach; ?>
                </div>
              </div>

              <button class="btn btn-outline-secondary w-100 text-start mb-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#backCollapse">
                Back Material <i class="fa fa-chevron-down float-end mt-1"></i>
              </button>
              <div class="collapse" id="backCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <?php if (isset($filterConfig['back_materials']))
                    foreach ($filterConfig['back_materials'] as $index => $material): ?>
                      <div class="form-check"><input class="form-check-input" type="checkbox"
                          value="<?php echo htmlspecialchars($material); ?>" id="backMaterial<?php echo $index; ?>"
                          name="back_material[]" /><label class="form-check-label"
                          for="backMaterial<?php echo $index; ?>"><?php echo htmlspecialchars($material); ?></label></div>
                    <?php endforeach; ?>
                </div>
              </div>

              <button class="btn btn-outline-secondary w-100 text-start mb-3" type="button" data-bs-toggle="collapse"
                data-bs-target="#frontCollapse">
                Frame Material <i class="fa fa-chevron-down float-end mt-1"></i>
              </button>
              <div class="collapse" id="frontCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <?php if (isset($filterConfig['frame_materials']))
                    foreach ($filterConfig['frame_materials'] as $index => $material): ?>
                      <div class="form-check"><input class="form-check-input" type="checkbox"
                          value="<?php echo htmlspecialchars($material); ?>" id="frameMaterial<?php echo $index; ?>"
                          name="frame_material[]" /><label class="form-check-label"
                          for="frameMaterial<?php echo $index; ?>"><?php echo htmlspecialchars($material); ?></label></div>
                    <?php endforeach; ?>
                </div>
              </div>
              ...
              <button class="btn btn-outline-secondary w-100 text-start mb-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#osCollapse">
                OS Family <i class="fa fa-chevron-down float-end mt-1"></i>
              </button>
              <div class="collapse" id="osCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <div class="row g-2">
                    <?php if (isset($filterConfig['os_families']))
                      foreach ($filterConfig['os_families'] as $index => $os): ?>
                        <div class="col-6">
                          <div class="form-check"><input class="form-check-input" type="checkbox"
                              value="<?php echo strtolower(htmlspecialchars($os)); ?>" id="os<?php echo $index; ?>"
                              name="os_family" /><label class="form-check-label"
                              for="os<?php echo $index; ?>"><?php echo htmlspecialchars($os); ?></label></div>
                        </div>
                      <?php endforeach; ?>
                  </div>
                </div>
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['os_version']['min']; ?>"
                    max="<?php echo $filterConfig['os_version']['max']; ?>"
                    step="<?php echo $filterConfig['os_version']['step']; ?>" id="osVersionMin"
                    value="<?php echo $filterConfig['os_version']['default']; ?>">
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['cpu_clock']['min']; ?>"
                    max="<?php echo $filterConfig['cpu_clock']['max']; ?>"
                    step="<?php echo $filterConfig['cpu_clock']['step']; ?>" id="cpuClockMin"
                    value="<?php echo $filterConfig['cpu_clock']['default']; ?>">
                  <span class="text-muted small"><?php echo $filterConfig['cpu_clock']['max']; ?></span>
                </div>
              </div>

              <button class="btn btn-outline-secondary w-100 text-start mb-3" type="button" data-bs-toggle="collapse"
                data-bs-target="#chipsCollapse">
              ...
              <div class="row g-2 mb-2">
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0 text-truncate" style="font-size: 0.85rem;"
                      for="accelSensor">ACCELEROMETER</label>
                ...
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0" style="font-size: 0.85rem;"
                      for="gyroSensor">GYRO</label>
                ...
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0" style="font-size: 0.85rem;"
                      for="baroSensor">BAROMETER</label>
                ...
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0" style="font-size: 0.85rem;" for="hrSensor">HEART
                      RATE</label>
                ...
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0" style="font-size: 0.85rem;"
                      for="compassSensor">COMPASS</label>
                ...
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0" style="font-size: 0.85rem;"
                      for="proxSensor">PROXIMITY</label>
              ...
              <button class="btn btn-outline-secondary w-100 text-start mb-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#fingerCollapse">
                Fingerprint <i class="fa fa-chevron-down float-end mt-1"></i>
              </button>
              <div class="collapse" id="fingerCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <?php if (isset($filterConfig['fingerprint_types']))
                    foreach ($filterConfig['fingerprint_types'] as $index => $fpType): ?>
                      <div class="form-check"><input class="form-check-input" type="checkbox"
                          value="<?php echo htmlspecialchars($fpType); ?>" id="fp<?php echo $index; ?>"
                          name="fingerprint[]" /><label class="form-check-label"
                          for="fp<?php echo $index; ?>"><?php echo htmlspecialchars($fpType); ?></label></div>
                    <?php endforeach; ?>
                </div>
              </div>
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['ram']['min']; ?>" max="<?php echo $filterConfig['ram']['max']; ?>"
                    step="<?php echo $filterConfig['ram']['step']; ?>" id="ramMin"
                    value="<?php echo $filterConfig['ram']['default']; ?>">
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['storage']['min']; ?>"
                    max="<?php echo $filterConfig['storage']['max']; ?>"
                    step="<?php echo $filterConfig['storage']['step']; ?>" id="storageMin"
                    value="<?php echo $filterConfig['storage']['default']; ?>">
            ...
            <div class="col-lg-6 col-12" id="pf-right-col">
              ...
              <div class="da-range-slider-wrapper mb-3">
                <div class="d-flex justify-content-between align-items-center mb-1">
                  ...
                  <span class="badge bg-secondary"><span
                      id="displaySizeMinValue"><?php echo $filterConfig['display_size']['default_min']; ?></span> -
                    <span
                      id="displaySizeMaxValue"><?php echo $filterConfig['display_size']['default_max']; ?></span>"</span>
                </div>
                <div class="d-flex align-items-center gap-2">
                  <span class="text-muted small"><?php echo $filterConfig['display_size']['min']; ?></span>
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['display_size']['min']; ?>"
                    max="<?php echo $filterConfig['display_size']['max']; ?>"
                    step="<?php echo $filterConfig['display_size']['step']; ?>" id="displaySizeMin"
                    value="<?php echo $filterConfig['display_size']['default_min']; ?>" />
                  <span class="mx-1">-</span>
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['display_size']['min']; ?>"
                    max="<?php echo $filterConfig['display_size']['max']; ?>"
                    step="<?php echo $filterConfig['display_size']['step']; ?>" id="displaySizeMax"
                    value="<?php echo $filterConfig['display_size']['default_max']; ?>" />
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['refresh_rate']['min']; ?>"
                    max="<?php echo $filterConfig['refresh_rate']['max']; ?>"
                    step="<?php echo $filterConfig['refresh_rate']['step']; ?>" id="refreshRateMin"
                    value="<?php echo $filterConfig['refresh_rate']['default']; ?>" />
              ...
              <div class="da-range-slider-wrapper mb-3">
                <div class="d-flex justify-content-between align-items-center mb-1">
                  ...
                  <span class="badge bg-secondary"><span id="displayResMinValue">min</span> - <span
                      id="displayResMaxValue">max</span></span>
                </div>
                <div class="d-flex align-items-center gap-2">
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['display_resolution']['min']; ?>"
                    max="<?php echo $filterConfig['display_resolution']['max']; ?>"
                    step="<?php echo $filterConfig['display_resolution']['step']; ?>" id="displayResMin"
                    value="<?php echo $filterConfig['display_resolution']['default_min']; ?>" />
                  <span class="mx-1">-</span>
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['display_resolution']['min']; ?>"
                    max="<?php echo $filterConfig['display_resolution']['max']; ?>"
                    step="<?php echo $filterConfig['display_resolution']['step']; ?>" id="displayResMax"
                    value="<?php echo $filterConfig['display_resolution']['default_max']; ?>" />
                </div>
              </div>
              ...
              <div class="collapse" id="techCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <?php if (isset($filterConfig['display_technologies']))
                    foreach ($filterConfig['display_technologies'] as $index => $tech): ?>
                      <div class="form-check"><input class="form-check-input" type="checkbox"
                          value="<?php echo htmlspecialchars($tech); ?>" id="tech<?php echo $index; ?>"
                          name="display_tech[]" /><label class="form-check-label"
                          for="tech<?php echo $index; ?>"><?php echo htmlspecialchars($tech); ?></label></div>
                    <?php endforeach; ?>
                </div>
              </div>

              <button class="btn btn-outline-secondary w-100 text-start mb-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#notchCollapse">
                Notch Style <i class="fa fa-chevron-down float-end mt-1"></i>
              </button>
              <div class="collapse" id="notchCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <div class="form-check"><input class="form-check-input" type="checkbox" value="No notch" id="notchNo"
                      name="display_notch[]" /><label class="form-check-label" for="notchNo">No Notch</label></div>
                  <div class="form-check"><input class="form-check-input" type="checkbox" value="Notch" id="notchYes"
                      name="display_notch[]" /><label class="form-check-label" for="notchYes">Notch</label></div>
                  <div class="form-check"><input class="form-check-input" type="checkbox" value="Punch hole"
                      id="notchPunch" name="display_notch[]" /><label class="form-check-label" for="notchPunch">Punch
                      hole</label></div>
                </div>
              </div>
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['f_number']['min']; ?>"
                    max="<?php echo $filterConfig['f_number']['max']; ?>"
                    step="<?php echo $filterConfig['f_number']['step']; ?>" id="fNumberMax"
                    value="<?php echo $filterConfig['f_number']['default']; ?>" />
              ...
              <div class="row g-2 mb-2">
                ...
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0" style="font-size: 0.85rem;"
                      for="camTele">TELEPHOTO</label>
                    <input class="form-check-input m-0" type="checkbox" id="camTele" name="main_camera_telephoto"
                      value="1">
                  </div>
                </div>
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0" style="font-size: 0.85rem;"
                      for="camUltra">ULTRAWIDE</label>
                    <input class="form-check-input m-0" type="checkbox" id="camUltra" name="main_camera_ultrawide"
                      value="1">
                  </div>
                </div>
                <div class="col-6">
              ...
              <div class="row g-2 mb-3">
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0" style="font-size: 0.85rem;" for="frontFlash">FRONT
                      FLASH</label>
                    <input class="form-check-input m-0" type="checkbox" id="frontFlash" name="selfie_camera_flash"
                      value="1">
                  </div>
                </div>
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0" style="font-size: 0.85rem;" for="popCam">POP-UP
                      CAM</label>
                ...
                <div class="col-12">
                  <div
                    ...
                    <input class="form-check-input m-0" type="checkbox" id="underDisplayCam" name="under_display_camera"
                      value="1">
                  </div>
                </div>
              </div>
              ...
              <button class="btn btn-outline-secondary w-100 text-start mb-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#wlanCollapse">
                WLAN (Wi-Fi) <i class="fa fa-chevron-down float-end mt-1"></i>
              </button>
              <div class="collapse" id="wlanCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <div class="form-check"><input class="form-check-input wifi-version" type="checkbox" value="802.11n"
                      id="wifi4" name="wifi_versions[]" /><label class="form-check-label" for="wifi4">Wi-Fi 4
                      (802.11n)</label></div>
                  <div class="form-check"><input class="form-check-input wifi-version" type="checkbox" value="802.11ac"
                      id="wifi5" name="wifi_versions[]" /><label class="form-check-label" for="wifi5">Wi-Fi 5
                      (802.11ac)</label></div>
                  <div class="form-check"><input class="form-check-input wifi-version" type="checkbox" value="802.11ax"
                      id="wifi6" name="wifi_versions[]" /><label class="form-check-label" for="wifi6">Wi-Fi 6
                      (802.11ax)</label></div>
                  <div class="form-check"><input class="form-check-input wifi-version" type="checkbox" value="802.11be"
                      id="wifi7" name="wifi_versions[]" /><label class="form-check-label" for="wifi7">Wi-Fi 7
                      (802.11be)</label></div>
                </div>
              </div>

              <button class="btn btn-outline-secondary w-100 text-start mb-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#usbCollapse">
                USB <i class="fa fa-chevron-down float-end mt-1"></i>
              </button>
              <div class="collapse" id="usbCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <div class="form-check"><input class="form-check-input usb-type" type="checkbox" value="USB-C"
                      id="usbTypeC" name="usb_types[]" /><label class="form-check-label" for="usbTypeC">Any
                      USB-C</label></div>
                  <div class="form-check"><input class="form-check-input usb-type" type="checkbox" value="USB 3"
                      id="usb3" name="usb_types[]" /><label class="form-check-label" for="usb3">USB-C 3.0 and
                      higher</label></div>
                  <div class="form-check"><input class="form-check-input usb-type" type="checkbox" value="micro USB"
                      id="microUsb" name="usb_types[]" /><label class="form-check-label" for="microUsb">Micro
                      USB</label></div>
                </div>
              </div>
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['battery_capacity']['min']; ?>"
                    max="<?php echo $filterConfig['battery_capacity']['max']; ?>"
                    step="<?php echo $filterConfig['battery_capacity']['step']; ?>" id="batteryCapacityMin" />
              ...
              <div class="da-range-slider-wrapper mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                  ...
                  <input type="range" class="form-range custom-range flex-grow-1"
                    min="<?php echo $filterConfig['wired_charging']['min']; ?>"
                    max="<?php echo $filterConfig['wired_charging']['max']; ?>"
                    step="<?php echo $filterConfig['wired_charging']['step']; ?>" id="wiredChargeMin" />
              ...
              <div class="row g-2 mb-3">
                <div class="col-6">
                  <div
                    ...
                    <input class="form-check-input m-0" type="checkbox" id="batRemov" name="battery_removable"
                      value="1">
                  </div>
                </div>
                <div class="col-6">
                  <div
                    class="form-check form-switch da-custom-switch p-2 border rounded d-flex align-items-center justify-content-between">
                    <label class="form-check-label fw-bold mb-0" style="font-size: 0.85rem;"
                      for="wirelessRequired">WIRELESS</label>
              ...
              <div class="row g-2 mb-3">
                <div class="col-6">
                  <div
                    ...
                    <input class="form-check-input m-0" type="checkbox" id="headphoneJack" name="headphone_jack"
                      value="1">
                  </div>
                </div>
                <div class="col-6">
                  <div
                    ...
                    <input class="form-check-input m-0" type="checkbox" id="dualSpeakers" name="dual_speakers"
                      value="1">
                  </div>
                </div>
              </div>
              ...
              <div class="card card-body mb-3 da-filter-card p-3">
                ...
                <input type="text" id="freeTextInput" class="form-control flex-grow-1 life"
                  placeholder="e.g. Sapphire crystal, Stylus" />
              </div>

              <!-- Sorting -->
              <h5 class="da-section-label mt-4 mb-3"><span>Sort By</span></h5>
              <button class="btn btn-outline-secondary w-100 text-start mb-2" type="button" data-bs-toggle="collapse"
                data-bs-target="#popularCollapse">
                Order <i class="fa fa-chevron-down float-end mt-1"></i>
              </button>
              <div class="collapse" id="popularCollapse">
                <div class="card card-body mb-3 da-filter-card">
                  <div class="form-check"><input class="form-check-input" type="checkbox" value="popularity"
                      id="orderPopularity" name="order[]" /><label class="form-check-label"
                      for="orderPopularity">Popularity</label></div>
                  <div class="form-check"><input class="form-check-input" type="checkbox" value="price" id="orderPrice"
                      name="order[]" /><label class="form-check-label" for="orderPrice">Price</label></div>
                  <div class="form-check"><input class="form-check-input" type="checkbox" value="camera_battery"
                      id="orderCamera" name="order[]" /><label class="form-check-label" for="orderCamera">Camera +
                      Battery</label></div>
                </div>
              </div>
