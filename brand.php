...
// Get all phones for this brand with advanced stats
$phones_stmt = $pdo->prepare("
    SELECT p.id, p.name, p.image, p.slug, p.year, p.price, p.availability, 
        ...
        <div class="row">
            <div class="col-lg-8 py-0" style="padding-left: 0; padding-right: 0; border: 1px solid #e0e0e0;">
                ...
                <div class="admin-device-grid">
                    ...
                    ?>
                        <a href="<?php echo $base; ?>device/<?php echo htmlspecialchars($deviceSlug); ?>" class="admin-device-card bg-white">
                            <?php if ($imagePath): ?>
