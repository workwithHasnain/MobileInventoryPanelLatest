...
<head>
  ...
  <link rel="canonical" href="<?php echo $canonicalBase; ?>/web-notifications" />
  <title>Web Notifications — DevicesArena</title>
    ...
    <div class="cp-hero">
      ...
      <div class="cp-hero-inner">
        <div class="cp-hero-left">
          <div class="cp-hero-label"><span>Help</span></div>
          <h1 class="cp-hero-title">Web Notifications</h1>
