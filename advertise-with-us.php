  ...
  <div class="da-page">
    ...
    <div class="cp-hero">
      ...
      <div class="cp-hero-bg-container">
        <img class="cp-hero-bg-img" src="<?php echo $base; ?>hero-images/advertise-hero.png"
          alt="advertise with us page background">
      </div>
      ...
      <div class="cp-hero-inner">
        <div class="cp-hero-left">
          ...
          <p class="cp-hero-sub">Partner with DevicesArena to reach a highly engaged, tech-savvy audience interested in
            smartphones, tablets, and mobile technology.</p>
        </div>
    ...
    <div class="da-content-area">
      ...
      <main>
        ...
        <div class="da-about-content">
          ...
          <p class="da-about-text">DevicesArena is a leading destination for smartphone specifications, comparisons, and
            reviews. Partner with us to reach a highly engaged, tech-savvy audience.</p>
          ...
          <form id="contact_form" class="da-form" novalidate>
            ...
            <div class="da-form-row">
              <div class="da-form-group">
                <input type="text" class="da-input" id="contact_name" name="contact_name"
                  placeholder="Your Name / Company *" maxlength="100" required>
                <div class="da-error-msg" id="name_error"></div>
              </div>
              <div class="da-form-group">
                <input type="email" class="da-input" id="contact_email" name="contact_email"
                  placeholder="Your Business Email *" maxlength="255" required>
            ...
            <div class="da-form-group">
              <textarea class="da-input" id="contact_query" name="contact_query" rows="5"
                placeholder="Tell us about your advertising needs, budget, and any specific requirements (no links allowed)..."
  ...
  <script>
    ...
    if (newsBtn && newsEmail && newsMsg) {
      newsBtn.addEventListener('click', function () {
        ...
        const btn = this;
        fetch(window.baseURL + 'handlers/handle_newsletter.php', {
          method: 'POST',
    ...
    (function () {
      ...
      if (contactForm) {
        contactForm.addEventListener('submit', function (e) {
          ...
          fetch(window.baseURL + 'handlers/handle_contact.php', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/x-www-form-urlencoded'
            },
