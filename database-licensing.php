...
<head>
  ...
  <link rel="canonical" href="<?php echo $canonicalBase; ?>/database-licensing" />
  <title>Database Licensing — DevicesArena</title>
    ...
    <div class="cp-hero">
      ...
      <div class="cp-hero-inner">
        <div class="cp-hero-left">
          <div class="cp-hero-label"><span>Licensing</span></div>
          <h1 class="cp-hero-title">Database Licensing</h1>
