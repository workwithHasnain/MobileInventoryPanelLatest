    ...
    <div id="bottom" class="container py-3 bottom">
        <div class="row">
            <div class="col-12">
                ...
                <form id="newsletter_form" method="POST" action=""
                    style="padding: 20px; border-radius: 4px; text-align: center;">
                    ...
                    <div style="display: flex; gap: 8px; justify-content: center; flex-wrap: wrap;">
                        <input type="email" id="newsletter_email" name="newsletter_email" placeholder="Enter your email"
                            required
                            style="padding: 10px 12px; border: 1px solid white; border-radius: 4px; font-size: 14px; flex: 1; min-width: 200px; max-width: 300px; background-color: white;">
                        <style>
                            input::placeholder {
                                color: #1B2035;
                                opacity: 0.7;
                        ...
                        <button type="submit" id="newsletter_btn"
                            style="padding: 10px 24px; background-color: white; color: #1B2035; border: none; border-radius: 4px; cursor: pointer; font-size: 14px; white-space: nowrap; font-weight: 500;">Subscribe</button>
                    </div>
                </form>
            </div>
        </div>
        <div class="row align-items-center">
            <div class="m-auto col-2 d-flex justify-content-center align-items-center" style="width: max-content;">
                <a href="<?php echo $base; ?>"><img src="<?php echo $base; ?>imges/logo-wide.png"
                        alt="devices arena logo for footer" style=" width: 185px;"></a>
            </div>
            <div class="col-10 nav-wrap m-auto text-center ">
                <div class="nav-container">
                    ...
                    <br>
                    <a href="https://youtube.com/@devicesarena" style="color: white;"> <i
                            class="fa-brands fa-youtube fa-sm"></i></a>
                    <a href="https://www.instagram.com/devicesarenaofficial/" style="color: white;"> <i
                            class="fa-brands fa-instagram fa-sm"></i></a>
                    <a href="https://www.tiktok.com/" style="color: white;"> <i
                            class="fa-brands fa-tiktok fa-sm"></i></a>
                    <a href="https://www.facebook.com/profile.php?id=61585936163841" style="color: white;"> <i
                            class="fa-brands fa-facebook-f fa-sm"></i></a>
                    <a href="https://www.twitter.com/" style="color: white;"> <i
                            class="fa-brands fa-twitter fa-sm"></i></a>
                    <br>
