  ...
  <div class="da-footer-container">
    ...
    <div class="da-footer-top-row">
      ...
      <div class="da-social-icons-top">
        <a href="https://www.facebook.com/profile.php?id=61585936163841" target="_blank" title="Facebook" class="fb"><i
      ...
      <div class="da-footer-col-group">
        <div class="da-footer-section">
          ...
          <ul class="da-footer-links inline-list">
            ...
            <li><a href="<?php echo $base; ?>carriers">Carriers</a></li>
    ...
    <div class="da-footer-newsletter-slim">
      <input type="email" id="ft-newsletter-email" class="da-fn-input" placeholder="Your email address"
